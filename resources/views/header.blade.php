...
<div class="header">
    <div class="pull-left">
        <div class="logo"><a href=""><span>Foodmin</span></a></div>
    ...
    <div class="pull-right p-r-15">
        <ul>
            ...
            <li class="header-icon dib"><img class="avatar-img" src="/images/bookingSystem/3.png" alt="" /> <span class="user-avatar">Admin <i class="ti-angle-down f-s-10"></i></span>
